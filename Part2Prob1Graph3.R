pied<-read.csv("C:/Users/Bhumika/Documents/DIC/KhatwaniLab1Part2/Genetic08.csv", header= TRUE)
pie_uni<-unique(pied$X.Sub.type)

par(mar = c(2,2,2,26))
Pie_main <- read.csv("C:/Users/Bhumika/Documents/DIC/KhatwaniLab1Part2//Pie_chart_data.csv", header=TRUE)
